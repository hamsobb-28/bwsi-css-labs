...
def test_addition():
    ...
    assert simple_calculator("add", -3, -4) == -7      # Test for addition of two negative numbers
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", -3, -4) == 12 # Test for multiplication of two negative numbers   
